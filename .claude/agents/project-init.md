...
사용자가 기술 스택을 확정하면, `.claude/README.md`의 CLAUDE.md 템플릿을 기반으로 프로젝트 루트에 `/CLAUDE.md`를 생성합니다.
...
**규칙 파일이 없는 경우:**
- 사용자에게 생성을 제안합니다.
- 동의하면 해당 기술 스택의 **시니어 수준 규칙 파일**을 생성합니다.
- 규칙 파일에 포함할 내용:
...
- **생성한 규칙 파일은 사용자에게 보여주고 확인받은 후 저장합니다.**
